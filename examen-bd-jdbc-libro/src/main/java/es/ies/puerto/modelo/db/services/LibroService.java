...
public class LibroService extends AbstractService<Libro> {
     ...
     * @return lista con el numero de libros por genero
     */
     ...
     * @param anio limite
     * @return libros de dado genero publicados despues de ese anio
     */
     ...
     * @return libros con autor y su nacionalidad
     */
     ...
     * @return libros mas cantidad de prestamos
     */
    ...
    /**
     * Metodo para obtener los autores y libros ordenados por cantidad de prestamos
     * @return libros
     */
