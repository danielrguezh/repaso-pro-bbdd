...
public class PrestamoService extends AbstractService<Prestamo> {
     ...
     * @param resultado
     * @return prestamo con propiedades
     */
     ...
     * @return prestamos durante esa fecha
     */
     ...
     * @return prestamos devueltos y la duracion del prestamo
     */
    ...
    /**
     * Metodo para obtener todos los prestamos con retraso de determinados dias
     * @param dias de prestamo
     * @return una lista con todos los prestamos con dicho retraso de devolucion
     */
     ...
     * @return prestamos y dias transcurridos
     */
    ...
    /**
     * Metodo que devuelve los prestamos que han sido devueltos rapidamente (en menos de 10 dias)
     * @return prestamos
     */
